...
class SliderAdapter (context: Context):PagerAdapter() {
    ...
    var slider_title = arrayOf("You’d rather create an account in order to follow your favorite event", "You will have a search access for all events of the universities clubs of Tunisia. ", "You can also have your own favorite Events as well as Clubs.")
